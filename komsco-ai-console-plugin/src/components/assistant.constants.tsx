...
export const TOOL_LABELS: Record<string, string> = {
  ...
  crashloop_demo_evidence: 'CrashLoopBackOff 시연 조회',
  crashloop_event_evidence: 'CrashLoopBackOff 이벤트 조회',
  crashloop_log_availability: '이전 로그 확인',
  crashloop_pod_snapshot: 'CrashLoopBackOff Pod 상태 조회',
  cronjob_activity_evidence: 'CronJob 실행 이력 조회',
  ...
  pod_snapshot_evidence: 'Pod 상태 스냅샷 조회',
  pod_status_evidence: 'Pod 상태/재시작 조회',
  pods_get: 'Pod 상세 조회',
  pods_list: 'Pod 목록 조회',
...
export const ACTION_POLICY_LABELS: Record<string, string> = {
  ...
  pod_fix_or_rollback_review: 'Pod 수정/롤백 검토',
  rollout_restart_deployment: '배포 롤아웃 재시작',
  rollback_deployment_to_revision: '이전 리비전으로 롤백',
  set_deployment_container_command: 'Deployment command 수정',
...
export const ACTION_POLICY_LABELS_EN: Record<string, string> = {
  ...
  pod_fix_or_rollback_review: 'Pod fix/rollback review',
  rollout_restart_deployment: 'Rollout restart Deployment',
  rollback_deployment_to_revision: 'Roll back Deployment',
  set_deployment_container_command: 'Update Deployment command',
