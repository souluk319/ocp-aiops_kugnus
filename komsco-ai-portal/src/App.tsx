...
import type { LedgerEntry } from './portalLedger';
import type {
  ActivityItem,
  AiopsEventFeed,
  AiopsEventItem,
...
const AppContent: React.FC<{
  ...
  if (activeView === 'reports') {
    ...
    return <ReportsView issueOptions={reportIssues.length > 0 ? reportIssues : sampleRcaQueues} status={status} summary={summary} />;
  }
