...
export KOMSCO_AI_PRODUCT_ACCESS_REVIEW_NAME="${KOMSCO_AI_PRODUCT_ACCESS_REVIEW_NAME:-cywell-aiops-console-plugin}"
...
echo "KOMSCO_AI_FORWARD_IMAGE_ATTACHMENTS_TO_OLS: ${KOMSCO_AI_FORWARD_IMAGE_ATTACHMENTS_TO_OLS:-false}"
