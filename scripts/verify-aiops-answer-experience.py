...
def main() -> None:
    ...
    require(ASSISTANT_EVIDENCE, "komsco-ai__footer-inline-summary", "console keeps Evidence detail toggle inline")
    require(ASSISTANT_EVIDENCE, "komsco-ai__footer-detail-toggle", "console has compact Evidence detail toggle")
